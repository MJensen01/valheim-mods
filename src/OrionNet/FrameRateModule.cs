    ...
    internal sealed class FrameRateModule : FeatureModule
    {
        ...
        public override void Configure(ConfigFile cfg)
        {
            EnabledCfg = cfg.Bind("FrameRate", "Enabled", true,
                "Allow OrionNet to set the server's frame cap. Does nothing while " +
        ...
        internal static void OnZNetStart()
        {
            ...
            {
                OrionNetPlugin.Log.LogInfo("[FrameRate] TargetFrameRate=0, leaving vanilla " +
            ...
            OrionNetPlugin.Log.LogInfo("[FrameRate] targetFrameRate " + oldTarget + " -> " +
        ...
        internal static void Tick(float dt)
        {
            ...
            Application.targetFrameRate = TargetFrameRate;
            QualitySettings.vSyncCount = 0;
            OrionNetPlugin.Log.LogInfo("[FrameRate] re-assert after 5s: was " + before +
