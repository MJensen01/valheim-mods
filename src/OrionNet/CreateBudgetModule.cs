...
namespace OrionNet
{
    ...
    internal sealed class CreateBudgetModule : FeatureModule
    {
        ...
        protected override void ApplyPatches()
        {
            ...
            if (target == null)
                throw new Exception("OrionNet CreateBudget: ZNetScene.CreateObjects not found");
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            if (matches != 1)
            {
                var msg = "OrionNet CreateBudget transpiler: expected exactly 1x " + VanillaMax +
            ...
            OrionNetPlugin.Log.LogInfo("[CreateBudget] transpiler OK: 1x maxCreatedPerFrame replaced (assertion 1 passed)");
            return list;
        }
    }
}
