...
namespace OrionQoL
{
    ...
    ///   int "orion_geartier". ZDO members replicate to every peer, so each client can read every
    ...
    internal sealed class VanguardShadowModule : FeatureModule
    {
        ...
        public const string ZdoKey = "orion_geartier";
