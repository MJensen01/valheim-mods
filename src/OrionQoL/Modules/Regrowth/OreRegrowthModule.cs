...
namespace OrionQoL
{
    ...
    internal sealed class OreRegrowthModule : FeatureModule
    {
        ...
        {
            get { return Path.Combine(Path.Combine(Paths.ConfigPath, "orion"), "regrowth.json"); }
        }
        ...
        protected override void ApplyPatches()
        {
            ...
            if (target == null)
                throw new Exception("OrionQoL OreRegrowth: ZDOMan.HandleDestroyedZDO(ZDOID) not found");

            var prefix = AccessTools.Method(typeof(OreRegrowthModule), nameof(HandleDestroyedZDO_Prefix));
            if (prefix == null)
                throw new Exception("OrionQoL OreRegrowth: own prefix method not found");
        ...
        private void StartTicker()
        {
            ...
            _tickerGo = new GameObject("OrionQoL_RegrowthTicker");
