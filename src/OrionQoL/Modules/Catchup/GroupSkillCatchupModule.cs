...
namespace OrionQoL
{
    ...
    ///
    /// CLIENT half
    ///   * Every ReportSec (60 s), sends "Orion_SkillReport" to the server: a ZPackage of
    ///     [int count]{[int skillType][float level]} for every skill above 0.
    ///   * Receives "Orion_SkillCeiling" (same layout) and caches it.
    ...
    ///   * Broadcasts "Orion_SkillCeiling" to everybody when the ceiling changes, and in any case
    ...
    internal sealed class GroupSkillCatchupModule : FeatureModule
    {
        ...
        internal const string RpcReport = "Orion_SkillReport";
        internal const string RpcCeiling = "Orion_SkillCeiling";
        ...
        public override string StatusDetail()
        {
            ...
            if (OrionQoLPlugin.IsServerSide)
            {
