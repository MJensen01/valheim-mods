...
namespace OrionQoL
{
    ...
    ///   * Persists to <Paths.ConfigPath>/orion/playtime.json (i.e. /config/bepinex/orion/).
    ...
    ///   * Sends the routed RPC "Orion_Catchup"(float gather, float xp) to that one peer.
    ///
    /// CLIENT half
    ///   * Receives "Orion_Catchup" and stores the two factors.
    ...
    internal sealed class PlaytimeRubberBandModule : FeatureModule
    {
        ...
        internal const string RpcCatchup = "Orion_Catchup";
