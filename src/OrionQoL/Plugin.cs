...
namespace OrionQoL
{
    ...
    public class OrionQoLPlugin : BaseUnityPlugin
    {
        public const string PluginGuid = "net.mjensen.orion.qol";
        public const string PluginName = "OrionQoL";
        ...
        private void Awake()
        {
            ...
            EnforceClientMod = BindSynced("General", "EnforceClientMod", true,
                "Server: require every connecting client to run OrionQoL " + PluginVersion +
            ...
            if (znetStart == null)
                ...
                _bootstrap.Patch(znetStart,
                    postfix: new HarmonyMethod(typeof(OrionQoLPlugin), nameof(ZNetStartPostfix)));
