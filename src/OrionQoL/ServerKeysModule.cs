...
namespace OrionQoL
{
    ...
    internal sealed class ServerKeysModule : FeatureModule
    {
        ...
        protected override void ApplyPatches()
        {
            ...
            if (target == null)
                throw new Exception("OrionQoL ServerKeys: ZoneSystem.SetStartingGlobalKeys(bool) not found");
        ...
        {
            // World keys are only rewritten on world load; a live edit takes effect on restart.
