...
namespace OrionQoL
{
    ...
    internal static class Frontier
    {
        ...
        {
            TierOverride = OrionQoLPlugin.BindSynced(Section, "TierOverride", -1,
            ...
            TiersBehind = OrionQoLPlugin.BindSynced(Section, "TiersBehind", 1,
        ...
        private static void OnConfigChanged(ConfigEntryBase entry)
        {
            if (entry == TierOverride || entry == TiersBehind)
                OrionQoLPlugin.Log.LogInfo("[Frontier] config changed: WorldTier=" + Describe() +
        ...
        public static bool Recompute()
        {
            ...
            if (changed)
                OrionQoLPlugin.Log.LogInfo("[Frontier] WorldTier=" + Describe() +
