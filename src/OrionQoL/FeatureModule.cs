...
namespace OrionQoL
{
    ...
    ///                                 summary, orion.status and the Harmony instance id.
    ...
    ///   override string StatusDetail() - one line of detail for orion.status.
    ///
    ...
    internal abstract class FeatureModule
    {
        ...
        protected static ManualLogSource Log => OrionQoLPlugin.Log;
        ...
        /// <summary>Extra detail for orion.status. Return null for none.</summary>
        ...
        {
            return OrionQoLPlugin.BindSynced(section, key, defaultValue, description, this);
        }
        ...
        {
            return OrionQoLPlugin.BindLocal(section, key, defaultValue, description, this);
        }
