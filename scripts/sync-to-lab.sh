#!/usr/bin/env bash
# Push this repo's src/ tree to the box lab (shroom-pi:/opt/modlab/src/), which stays the
# build+test environment (see research/BUILD-LAB.md) until CI is proven out end-to-end.
#
# Because src/Directory.Build.props is the nearest such file to each .csproj, once synced it
